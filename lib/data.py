...
from importlib.zresources import path
...
def cat_process_nans(X: ArrayDict, policy: Optional[CatNanPolicy]) -> ArrayDict:
    ...
    X = {k: v.astype(np.ndarray) if isinstance(v, np.ndarray) else v for k, v in X.items()}
